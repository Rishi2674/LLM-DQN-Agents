...
class DQNModel:
    ...
    def train(self, batch_size):
        ...
        for state, action, reward, next_state, done in minibatch:
            ...
            prompt = self.llm_generator.create_prompt(state, action, reward, next_state, done, self.maze)
            llm_response = self.llm_generator.generate_experience(prompt)
            extracted_values = self.llm_generator.parse_llm_response(llm_response)
            if extracted_values is None:  # Skip if parsing fails
                print("Skipping invalid experience generated by LLM")
                continue
            next_state_llm, action_llm, reward_llm, done_llm, context_value = extracted_values
